...
| Модель                     | Train RMSE | Test RMSE | Train MAE | Test MAE | Train R² | Test R² | Train RMSSE | Test RMSSE |
| :------------------------- | ---------- | --------- | --------- | -------- | -------- | ------- | ----------- | ---------- |
| **LAMA Baseline (Best)**   | -          | 0.0425    | -         | 0.0140   | -        | 0.9997  | -           | 0.0228     |
| Custom Solution (LightGBM) | 0.0500     | 0.1087    | 0.0136    | 0.0203   | 0.9996   | 0.9983  | 0.0267      | 0.0581     |
